...
subroutine sim_init(setup,state,perturb,data_assim,Ntimes,Nens,sig_sm,Nlag,isOneStep,doEQ,EQs,ofile)
 ...
 type(setup_data)   :: setup
 logical, intent(out) :: perturb,data_assim,isOneStep,doEQ
...
subroutine printstatevalues(t, state, Nt)
 use type_decs
 implicit none
 integer, intent(in) :: t
 integer, intent(in) :: Nt
 type(state_data),   intent(in), dimension(Nt) :: state
 print*, 'States at time=' 
 print*, t
 print*, 'stc'
 print*, state(t)%stc
 print*, 'zsnso'
 ...
 print*, state(t)%sneqv   
 print*, 'canliq'  
 print*, state(t)%canliq  
 print*, 'rtmass'  
 print*, state(t)%rtmass  
 print*, 'albold'  
 print*, state(t)%albold  
 print*, 'lai'     
 print*, state(t)%lai     
 print*, 'tv'      
 print*, state(t)%tv      
 ...
 print*, state(t)%wood
 print*, 'lfmass'
 print*, state(t)%lfmass
 print*, 'stmass'
 print*, state(t)%stmass
