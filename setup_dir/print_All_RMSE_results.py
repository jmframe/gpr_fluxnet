...
pd_results = pd.DataFrame(index=list_siteyears, columns=['RMSE_CalNoah_in','RMSE_NoahGPR_in',\
    'RMSE_CalNoah_out','RMSE_NoahGPR_out', \
    'NSE_CalNoah_in','NSE_NoahGPR_in','NSE_CalNoah_out','NSE_NoahGPR_out'])
...
for S, Y in siteyears:
    ...
    pd_results.loc[[siteyear],:] = [Cal_RMSE, GPR_RMSE, NoahRMSE, GPRRMSE, Cal_NSE, GPR_NSE,  NoahNSE, GPRNSE]
print(pd_results)
