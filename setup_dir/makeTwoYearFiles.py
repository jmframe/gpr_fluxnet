...
# Define the years for the out of sample tests.
# Need to make this smart to generate automatically based on site years
# Maybe not, I can just manually do this for all sites, once I know the criteria.
OutSam = {}
OutSam[2000] = [2001, 2002]
OutSam[2001] = [2002, 2003]
OutSam[2002] = [2003, 2004]
OutSam[2003] = [2004, 2005]
OutSam[2004] = [2005, 2006]
OutSam[2005] = [2003, 2004]
OutSam[2006] = [2004, 2005]
