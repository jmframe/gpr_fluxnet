...
siteyear = sys.argv[1]
gpr_mpi_dir = sys.argv[2]
gpr_noah_dir = sys.argv[3]
# Generate the training/testing data from the initialization directory.
#def gpr_train_data(siteyear, gpr_noah_dir, gpr_mpi_dir):
